...
División: ÷
    ...
    1- 
    2- 
    jugadoresRiverActuales <= π dni, nombre, apellido, edad, codigoCiudad (σ hasta > '2024-01-01' ^ club.nombre = 'River Plate'(Jugador ⨝ ClubJugador ⨝ Club))
    jugadoresBoca <= π dni, nombre, apellido, edad, codigoCiudad (σ hasta < '2024-01-01' ^ club.nombre = 'Boca Juniors'(Jugador ⨝ ClubJugador ⨝ Club))
    π dni, nombre, apellido, edad, codigoCiudad (jugadoresRiverActuales ∩ jugadoresBoca+)